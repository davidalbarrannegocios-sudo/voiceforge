    ...
    <div className="min-h-screen" style={{ background: "#0a0a0f", color: "white" }}>
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-20 items-center">
          ...
          >
            ...
            <p className="text-sm" style={{ color: "#888888" }}>Tu creatividad, amplificada por IA.</p>
          </div>
        </div>

        {/* Technology */}
        <div className="rounded-2xl border p-8 mb-20" style={{ background: "#111111", borderColor: "#222222" }}>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={label} className="rounded-xl p-4" style={{ background: "#111111", border: "1px solid #2a2a3e" }}>
        ...
        <div className="mb-20">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {VALUES.map(({ title, desc }) => (
              <div key={title} className="rounded-2xl border p-6" style={{ background: "#111111", borderColor: "#222222" }}>
        ...
        <div className="text-center">
          ...
          <p className="text-sm mb-6" style={{ color: "#888888" }}>Sin tarjeta de crédito. Explora las voces gratis.</p>
          <Link
            href="/dashboard"
      ...
      <footer className="border-t mt-16 py-6 px-6" style={{ borderColor: "#222222" }}>
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs" style={{ color: "#555555" }}>© 2026 Elite Tube LLC. All rights reserved.</p>
          <div className="flex gap-5">
            <Link href="/privacy" className="text-xs transition-colors hover:text-gray-300" style={{ color: "#555555" }}>Política de privacidad</Link>
            <Link href="/terms" className="text-xs transition-colors hover:text-gray-300" style={{ color: "#555555" }}>Términos de uso</Link>
            <Link href="/support" className="text-xs transition-colors hover:text-gray-300" style={{ color: "#555555" }}>Soporte</Link>
          </div>
        </div>
      </footer>
    </div>
