          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
            ...
            <div style={{ padding: '24px', background: 'rgba(255,255,255,0.02)' }}>
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                ...
                <a
                  href="https://www.elitelabs.es/docs"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-4 py-2 bg-white/5 text-white/60 text-sm rounded-xl hover:bg-white/10 hover:text-white border border-white/10 transition-colors flex items-center gap-2"
                >
